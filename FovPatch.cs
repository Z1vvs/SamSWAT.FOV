...
namespace SamSWAT.FOV
{
    ...
    {
        private static readonly FieldInfo FovValuesField = typeof(GameSettingsTab).GetField("readOnlyCollection_0", BindingFlags.Static | BindingFlags.NonPublic);
        ...
        private static void PatchPrefix()
        {
            ...
            var fovValues = Array.AsReadOnly(Enumerable.Range(FovPlugin.MinFov.Value, rangeCount).ToArray());
